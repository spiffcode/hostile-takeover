...
bool UnitGob::InitClass(UnitConsts *puntc, IniReader *pini)
{
	...
	if (gaptbmScorches[0] == NULL) {
		gaptbmScorches[0] = CreateTBitmap("scorch_8x8.png");
		gaptbmScorches[1] = CreateTBitmap("scorch_16x16.png");
		gaptbmScorches[2] = CreateTBitmap("scorch_32x16.png");
		gaptbmScorches[3] = CreateTBitmap("scorch_48x48.png");
	}
