...
Description=Equipped with a fine mortor cannon. Increased damage against buildings.
...
Description=This tank's dual cannons can quickly do serious damage to enemy infantry.
...
[kgtResearchCenter]
Name=R&D Center
LongName=Research & Development Center (R&D)
TimeToBuild=15
Cost=750
PowerDemand=15
ArmorStrength=250
